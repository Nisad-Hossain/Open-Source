    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                print(f'{N}══════════════════════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[SHIHAB-CP] ", "")}{N}')
                try:
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[SHIHAB]","\x1b[1;92m[SHIHAB]","\x1b[1;92m[SHIHAB]","\x1b[1;92m[SHIHAB]","\x1b[1;92m[SHIHAB]","\x1b[1;92m[SHIHAB]","\x1b[1;92m[SHIHAB]"])
